<div class="input-section">
  <div class="form-col-title">Navigation Links</div>
  <div class="input-group nav-input nav-input-1" data-preview="nav-link-1" data-valid="text" data-css="" data-reset="">
  ...
  <div class="input-group nav-input nav-input-2" data-preview="nav-link-2" data-valid="text" data-css="" data-reset="">
    <label><span class="remove-link">X</span>Link Title:</label>
  ...
  <div class="input-group nav-input nav-input-3" data-preview="nav-link-3" data-valid="text" data-css="" data-reset="">
    <label><span class="remove-link">X</span>Link Title:</label>
  ...
  <div class="input-group nav-input nav-input-4" data-preview="nav-link-4" data-valid="text" data-css="" data-reset="">
    <label><span class="remove-link">X</span>Link Title:</label>
  ...
  <div class="input-group nav-input nav-input-5" data-preview="nav-link-5" data-valid="text" data-css="" data-reset="">
    <label><span class="remove-link">X</span>Link Title:</label>
  ...
  <div class="input-group add-nav-container">
    <label>Add Nav Link (Max 5)</label>
    <button class="add-nav-link">+</button>
  </div>
</div>
